...
public interface DeliveryRepository extends CrudRepository<Delivery,String>{
	...
	@Query(value="SELECT paid,topay from t_booking tb join t_inventory ti on tb.lr_number =?1 and tb.ogpl_no =ti.ogpl_no",nativeQuery=true)

	DeliveryDto getDelivery(String lrNumber);
} 
