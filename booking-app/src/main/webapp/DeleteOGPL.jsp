...
<script type="text/javascript" charset="utf-8">
	function getSearchParcel() {
		...
		window.location.href = "/searchParcelLRNODeleteOGPL?lrNumber=" + value;
		/* } else {
             ...
             $(function() {
                 $("#txtSearch").autocomplete({
                     source: function(request, response) {
                         $.ajax({
                        	 url : "/dbSearchParcelLRNODeleteOGPL?userId="+document.getElementById("userName").value+"&lrNumber="+lrNumber.value,
                             type: "GET",
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="blog-details-inner">
								<main>
									<form action="/deleteOgplSave" method="post" style="width: 100%;" name="deliveryform" id="deliveryform">
												...
												<div class="row element-margin">
													<div class="input-group">
														 ...
														 <input type="text" class="form-control"
															placeholder="Type LR No" name="txtSearch" value="${deliveryB.lrNumber}" id="txtSearch" onkeyup="searchLRNumber(this);">
